...
export default function SupportPage() {
  return (
    <>
      ...
      {/* 03 — Supply & Replacement Coordination */}
      <section className="border-b border-[rgba(44,74,115,0.10)]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-16 md:py-24">
          <div className="max-w-2xl">
            ...
            <h2 className="font-heading text-2xl md:text-3xl font-medium text-[#1B1E20] mb-4">
              Coordinate What Comes Next
            </h2>
            <p className="text-[#4A4E54] leading-relaxed mb-10">
              For recurring requirements, production and replenishment can be
              coordinated around agreed demand and delivery requirements.
            </p>

            <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-2 text-sm text-[#4A4E54]">
              <span className="px-4 py-2 border border-[rgba(44,74,115,0.10)] rounded-md bg-[#FAFAF7]">
                Requirement
              </span>
              <span className="text-[#62666C]" aria-hidden="true">
                →
              </span>
              <span className="px-4 py-2 border border-[rgba(44,74,115,0.10)] rounded-md bg-[#FAFAF7]">
        ...
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="p-8 border border-[rgba(44,74,115,0.10)] rounded-md">
              <p className="font-heading text-4xl font-medium text-[#2C4A73] mb-1">
                12 Months
              </p>
              <p className="text-sm text-[#4A4E54]">Standard Warranty</p>
            </div>
            <div className="p-8 border border-[rgba(44,74,115,0.10)] rounded-md">
              <p className="font-heading text-4xl font-medium text-[#2C4A73] mb-1">
                24 Hours
          ...
          <p className="text-sm text-[#62666C] leading-relaxed max-w-2xl">
            Initial response time refers to the typical time to acknowledge and
            begin reviewing an inquiry.
          </p>
        </div>
      </section>

      {/* 05 — How Support Works */}
      <section className="border-b border-[rgba(44,74,115,0.10)]">
        <div className="max-w-[1200px] mx-auto px-6 md:px-8 py-16 md:py-24">
